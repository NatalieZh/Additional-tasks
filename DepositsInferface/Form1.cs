    ...
    public partial class Form1 : Form
    {
        ...
        private void  GridLoad()
        {
            ...
            for (int i = 0; i < client.Deposits.Length; i++)
            {
                ...
                if (tmpDeposit != null)
                {
                    bool isProlongable = tmpDeposit is IProlongable && (tmpDeposit as IProlongable).CanToProlong();
                    grdDeposits.Rows.Add(i + 1, tmpDeposit.Type, tmpDeposit.StartSum, tmpDeposit.Period, isProlongable, tmpDeposit.Income(), tmpDeposit.Amount);
                }
                else
                {
        ...
        private void LoadInfo()
        {
            ...
            lblProlongable.Text = client.CountPossibleToProlongDeposit().ToString();
        }
